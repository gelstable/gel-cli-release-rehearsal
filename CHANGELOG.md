...
- safely replace stale candidate drafts
- allow stable gate draft verification
- match install fixture to candidate channel
- allow empty candidate resolution
- publish changelog release notes

#### Show the prepared changelog in GitHub release descriptions while retaining

candidate provenance in a hidden metadata comment.
